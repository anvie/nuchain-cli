...
import {
    ...
    LeU64Bytes,
    LeU128Bytes
} from "@nuchain-cli/util"
import {CliBaseCommand} from "@nuchain-cli/core";
...
export default class Crowdloan extends CliBaseCommand {
    ...
    static description = 'Nuchain cli command that allows to fetch crowdloan contributions from a relay chain and initialize ' +
        'the crowdloan modules on the parachain'

    static examples = [
        `$ crowdloan --relay wss://rpc.polkadot.io --para wss://portal.chain.nuchain.id ` +
