...
export default class Migration extends CliBaseCommand {
    ...
    static description = 'Nuchain cli command that allows to migrate from a stand-alone to a parachain.'

    static examples = [
        `$ crowdloan --source-network wss://rpc.polkadot.io --destnation-network wss://portal.chain.nuchain.id ` +
